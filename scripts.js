...
const productTemplate =
  '  <div class="prod-card-img" onclick="window.location.hash = \'#product/{{ url }}\'">\n' +
...
const productInfoTemplate =
  '  <div class="prod-info-img" onclick="window.location.hash = \'#product/{{ url }}\'">\n' +
  '    <div class="btn-favorite " data-auth="0">\n' +
  '      <i class="fa  fa-heart-o " aria-hidden="true"></i>\n' +
  '    </div>\n' +
  '    <img src="{{ image }}" alt="fish">\n' +
...
window.addEventListener('popstate', async () => {
  ...
  if (hash === '') {
    ...
    product.innerHTML = Mustache.render(productInfoTemplate, parsed);
  } else {
